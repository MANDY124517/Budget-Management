    ...
    <div className="min-h-screen bg-obsidian-950 flex flex-col justify-center items-center p-4 relative overflow-hidden">
      ...
      >
        ...
        <div className="text-center mb-7">
          ...
          <h1 className="text-2xl font-extrabold text-white tracking-tight">SmartBudget</h1>
          <p className="text-xs text-slate-400 mt-1 font-medium">Bespoke Financial Intelligence Platform</p>
        </div>
        ...
        <div className="glass-card-elevated rounded-3xl p-8 shadow-2xl border border-white/[0.08]">
          ...
          <p className="text-xs text-slate-400 mb-6 font-medium">Sign in to manage your budgets, goals, and ML analytics.</p>
          ...
          <div className="mt-6 pt-6 border-t border-white/[0.06] text-center">
            <p className="text-xs text-slate-400 font-medium">
              ...
              <Link to="/register" className="text-brand-300 hover:text-white font-bold transition-colors">
                Create one now
              </Link>
            </p>
          </div>
